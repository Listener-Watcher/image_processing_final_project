...
def train(model, train_loader, criterion, optimizer, device, writer):
    ...
    return epoch_loss
def train_labelnoise(model, train_loader, criterion, optimizer, device, writer,prob):
    total_loss = []
    global iteration
...
for epoch in trange(num_epochs):
    if noise != 'label':        
        ...
        train_loss = train_labelnoise(model, train_loader,criterion, optimizer, device, writer,prob)
